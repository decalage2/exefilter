...
# -*- coding: iso-8859-1 -*-
"""
Filtre_GIF - ExeFilter

Ce module contient la classe L{Filtre_GIF.Filtre_GIF},
...
# classe FILTRE_GIF
#-------------------
class Filtre_GIF (Filtre.Filtre):
    """
    classe pour un filtre de fichiers Gif.

    un objet Filtre sert à reconnaître le format d'un fichier et à
    nettoyer le code éventuel qu'il contient. La classe Filtre_GIF
    correspond aux fichiers images GIF.
    ...
    def reconnait_format(self, fichier):
        ...
        if debut.startswith("\x47\x49\x46\x38"):
            return True
