...
# -*- coding: iso-8859-1 -*-
"""
Filtre_JPEG - ExeFilter

Ce module contient la classe L{Filtre_JPEG.Filtre_JPEG},
pour filtrer les fichiers images JPEG.
...
# classe FILTRE_Jpeg
#-------------------
class Filtre_JPEG (Filtre.Filtre):
    """
    classe pour un filtre de fichiers images Jpeg.

    un objet Filtre sert à reconnaître le format d'un fichier et à
    nettoyer le code éventuel qu'il contient. La classe Filtre_Jpeg
    correspond aux fichiers image JPEG.
    ...
    def reconnait_format(self, fichier):
        ...
        if debut.startswith("\xFF\xD8\xFF"):
            return True
