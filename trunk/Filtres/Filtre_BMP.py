...
# -*- coding: iso-8859-1 -*-
"""
Filtre_BMP - ExeFilter

Ce module contient la classe L{Filtre_BMP.Filtre_BMP},
pour filtrer les fichiers images BMP.
...
# classe FILTRE_TEXTE
#-------------------
class Filtre_BMP (Filtre.Filtre):
    """
    classe pour un filtre de fichiers BMP.
